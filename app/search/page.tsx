  ...
  async function run() {
    try {
      const supabase = createClient(
        "https://iwfnkmgiittsxylwxydz.supabase.co",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml3Zm5rbWdpaXR0c3h5bHd4eWR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkwMjk0NzYsImV4cCI6MjA5NDYwNTQ3Nn0.sQOwz-7wPKAMI6d3QKFKk8pOV_N2YQS4HN1q1WTAiMw"
      );
